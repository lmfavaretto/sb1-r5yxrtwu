/*
  # Fix customer data inconsistency

  1. Changes
    - Reset total_orders and total_spent for all customers
    - Add reference column to orders table if not exists
    - Add unique constraint on reference to prevent duplicate orders
    - Add trigger to update customer totals on order changes

  2. Notes
    - This migration will prepare the database for accurate data sync
    - Customer totals will be recalculated based on actual orders
*/
